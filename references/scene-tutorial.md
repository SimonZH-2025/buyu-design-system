...
| 用途 | 变量名 | 色值 | 说明 |
|------|--------|------|------|
| 主黄 | `--yellow` | `#F2C53D` | 强调、装饰圆圈、连接线、badges |
| 柔黄 | `--yellow-soft` | `#FBE6A8` | 背景块、气泡底色 |
| 主蓝 | `--blue` | `#2F6FB0` | 英文标题、超链、重点标记 |
| 深蓝 | `--blue-deep` | `#245B91` | 大装饰字、section数字编号 |
| 红色 | `--red` | `#D8453B` | 点缀、高亮下划线、标签 |
| 奶白底 | `--cream` | `#FFF8EF` | 页面主背景 |
| 深奶底 | `--cream-dark` | `#F5E9D6` | section间交替背景 |
| 墨色 | `--ink` | `#2A2A33` | 正文主色（非纯黑） |
| 浅墨 | `--ink-light` | `#6A6A76` | 次要正文 |
| 淡墨 | `--ink-faint` | `#9A9AA6` | 辅助文字、标签 |
...
| 中文标题首选 | `Noto Serif SC`（思源宋体） | 品牌真正用的标题字体，需本地字体文件 |
| 中文标题备选 | `Noto Serif SC` (Google Fonts) | 当无思源宋体时使用 |
...
- 选中文本高亮：`::selection { background: #F2C53D; color: #1a1a1a; }`
